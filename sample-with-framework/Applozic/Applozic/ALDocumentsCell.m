...
-(instancetype) populateCell:(ALMessage *) alMessage viewSize:(CGSize)viewSize
{
    ...
    if([alMessage isReceivedMessage])
    {
          ...
          if(alMessage.groupId)
        {
            ...
            [self.mChannelMemberName setTextColor: [ALColorUtility getColorForAlphabet:receiverName withDictionary:self.colourDictionary]];
        ...
        else
        {
            ...
            self.mUserProfileImageView.backgroundColor = [ALColorUtility getColorForAlphabet:receiverName withDictionary:self.colourDictionary];
        }
