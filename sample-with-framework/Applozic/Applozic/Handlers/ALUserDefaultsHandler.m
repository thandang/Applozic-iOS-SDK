...
+(void) clearAll
{
    ALSLogBasic(ALLoggerSeverityInfo, @"CLEARING_USER_DEFAULTS");
...
+(void)setLastSyncTime :( NSNumber *) lstSyncTime
{
    ...
    ALSLogBasic(ALLoggerSeverityInfo, @"saving last Sync time in the preference ...%@" ,lstSyncTime);
...
{
    ALSLogBasic(ALLoggerSeverityInfo, @"saving last seen time in the preference ...%@" ,lastSeenTime);
