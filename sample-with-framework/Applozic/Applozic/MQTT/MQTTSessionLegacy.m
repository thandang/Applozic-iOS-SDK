...
- (MQTTSession *)initWithClientId:(NSString *)clientId
    ...
    ALSLogBasic(ALLoggerSeverityInfo, @"[MQTTSessionLegacy] initWithClientId:%@ ", clientId);
...
- (void)connectToHost:(NSString *)host
    ...
    ALSLogBasic(ALLoggerSeverityInfo, @"MQTTSessionLegacy connectToHost:%@ port:%d usingSSL:%d connectHandler:%p",
